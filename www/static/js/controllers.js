...
app.controller('myController', ['$scope', '$http', '$window', function ($scope, $http, $window) {
    ...
    $scope.submitForm = function () {
        ...
        // $window.location.href = 'http://localhost:8000/?type_id='+$scope.typeSelected[0].id;
        $window.location.href = 'https://apptradedesk.zination.com/?type_id='+$scope.typeSelected[0].id;
    }
